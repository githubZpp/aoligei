#!/bin/bash
#NDK路径
export ANDROID_NDK_ROOT=/home/zp/Desktop/ffmpeg_build/android-ndk-r14b
export AOSP_TOOLCHAIN_SUFFIX=4.9
#arm64-v8a 最低支持 android-21  编译armeabi-v7a 用 android-16
  ...
  ;;
	...
	;;
	  ...
	  ;;
		...
		FF_CFLAGS="-O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  "
		;;
		  armv8|armv8a|aarch64|arm64|arm64-v8a) TOOLCHAIN_BASE="aarch64-linux-android" TOOLNAME_BASE="aarch64-linux-android"
		  AOSP_ABI="arm64-v8a"
		  ARCH="aarch64"
